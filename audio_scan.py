...
class audio_scan(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "cbrs_Scan")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("cbrs_Scan")
        ...
        self.settings = Qt.QSettings("GNU Radio", "audio_scan")
        ...
        self._center_freq_range = Range(88e6, 108e6, 200e3, 98.5e6, 200)
...
def main(top_block_cls=audio_scan, options=None):
